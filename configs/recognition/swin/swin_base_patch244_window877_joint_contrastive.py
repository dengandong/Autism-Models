...
data_root = ''
data_root_val = ''
ann_file_train = 'data/Joint/Joint_train.txt'
ann_file_val = 'data/Joint/SSDB_test.txt'
ann_file_test = 'data/Joint/Joint_test.txt'
img_norm_cfg = dict(
...
work_dir = './work_dirs/Joint_contrastive_SSBD/'
